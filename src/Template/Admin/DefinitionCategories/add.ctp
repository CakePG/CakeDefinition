<?php
  $this->layout = 'admin';
  $this->assign('title', __d('CakeDefinition', 'Definition Category').'登録 - '.__d('CakeDefinition', 'Website Admin Title').' | '.__d('CakeDefinition', 'Website Title'));
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active" aria-current="page"><?= __d('CakeDefinition', 'Definition Category') ?>登録</li>
</ol>

<div class="container">
  <div class="row align-items-end mb-2">
    <div class="col-md">
      <h2><?= __d('CakeDefinition', 'Definition Category') ?>登録<hr class="d-none d-md-block"></h2>
    </div>
